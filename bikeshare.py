...
def get_filters():
    ...
    if filter_option in ["month", "both"]:
        ...
        while True:
            ...
            if month not in FILTER_MONTHS and month != 'all':
                print("\nThe inputed month is invalid, try again.")
                print("\n")
                continue
            else:
                break
    ...
    if filter_option in ["day", "both"]:
        ...
        while True:
            day = input("Which day - Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday or all - for the whole week?\n").lower()
            if day not in FILTER_DAYS_OF_WEEK and day != 'all':
                print("\nThe inputed day is invalid, try again.")
                print("\n")
                continue
            else:
                break
...
def load_data(city, month, day):
    ...
    if day and day != 'all':
        filter_day = FILTER_DAYS_OF_WEEK.index(day)
        df = df[df['day_of_week'] == filter_day]
